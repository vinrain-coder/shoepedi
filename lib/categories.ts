    ...
    subcategories: [
      {
        ...
        minicategories: [
          ...
          },
          {
            name: "T-Shirts",
            slug: "men-t-shirts",
            seoTitle: "Men's T-Shirts",
            seoDescription: "Buy stylish men's t-shirts.",
            seoKeywords: ["t-shirts", "men"],
          },
          {
            name: "Jeans",
            slug: "men-jeans",
            seoTitle: "Men's Jeans",
            seoDescription: "Buy stylish men's jeans.",
            seoKeywords: ["jeans", "men"],
          },
          {
            name: "Watches",
            slug: "men-watches",
            seoTitle: "Men's Watches",
            seoDescription: "Buy stylish men's watches.",
            seoKeywords: ["watches", "men"],
          },
          {
            name: "Shoes",
            slug: "men-shoes",
            seoTitle: "Men's Shoes",
            seoDescription: "Buy stylish men's shoes.",
            seoKeywords: ["shoes", "men"],
          },
        ],
      },
      {
