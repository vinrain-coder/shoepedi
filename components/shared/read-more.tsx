  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {!expanded && showButton && (
          <div className="absolute bottom-0 left-0 w-full h-16 bg-linear-to-t from-white to-transparent dark:bg-linear-to-t dark:from-black/80 dark:to-transparent pointer-events-none" />
        )}
      </div>
